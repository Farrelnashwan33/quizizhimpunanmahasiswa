<script lang="ts">
	...
	import { ShieldAlert, Bell, X, Volume2, VolumeX, AlertTriangle } from 'lucide-svelte';
...
<div class="min-h-[calc(100vh-4rem)] flex flex-col md:flex-row bg-slate-900 text-slate-100 relative">
	<!-- Admin Sidebar -->
	<AdminSidebar profile={data.profile} />

	<!-- Main Admin Content Area -->
	<div class="flex-1 bg-slate-950 flex flex-col overflow-y-auto">
		<!-- Top Live Proctoring Bar -->
		<div class="bg-slate-900/90 border-b border-slate-800/80 px-4 sm:px-6 py-2.5 flex items-center justify-between gap-3 text-xs">
			<div class="flex items-center gap-2">
				...
				{:else}
					<span class="px-2 py-0.5 rounded-full bg-emerald-950 text-emerald-300 border border-emerald-800 text-[10px] font-medium hidden sm:inline">
